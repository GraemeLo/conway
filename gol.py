...
# What does interval mean in animation.FuncAnimation

def randomGrid(N):
    # creates a random 2D array with probabilistic occurences
    return np.random.choice([255, 0], N*N, p=[0.08, 0.92]).reshape(N, N)
